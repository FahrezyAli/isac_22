...
@section('content')
    ...
    <div class="regis-lomba__content">
        @if ($daftar == false)
            <div class="regis-lomba__title-section">
                ...
                <p class="regis-lomba__subtitle">
                    Untuk mengikuti ISAC Olympiad, tim dapat melakukan pembayaran sejumlah Rp90.000,-
            ...
            <form method="post" action="{{ route('registB', ['namaTim' => $namaTim]) }}" enctype="multipart/form-data"
        ...
        @elseif($verified == true)
            ...
            <h4 class="regis-lomba__confirm-subtitle">Jangan lupa join grup Telegram <a
                    href="https://t.me/+sUXTWBa1DW45NzI1" target="_blank" rel="noopener noreferrer">disini</a> untuk
                informasi lebih lanjut</h4>
